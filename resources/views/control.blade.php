<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <div class="flex justify-between">
            <div class="pt-2"><h2 class="text-2xl font-bold text-gray-900 dark:text-white">Control de Colaboradores</h2></div>
        ...
        <x-jet-validation-errors class="mb-4" />
         ...
         <h3 class="font-bold text-gray-900 dark:text-white">Ingresar su DNI para registrar su ingreso o salida de tienda.</h3>
