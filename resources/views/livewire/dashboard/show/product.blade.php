<div class="flex justify-center p-4">
    <div>
        ...
        <script>
            ...
            @endfor
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600"></div>
            @endfor
            ...
            <script>
                ...
                {
                    let count = document.getElementById('product-ofertas').value;
