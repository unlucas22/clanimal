<div class="flex justify-center pt-8">
    <form method="POST" action="{{ route('dashboard.store.marketing-templates') }}" class="space-y-4" enctype="multipart/form-data">
    <h2 class="mb-4 text-2xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white mt-2">Crear Plantilla</h2>
        ...
        <div class="flex justify-center">
            <div class="flex justify-between gap-8">
                <div>
                    <x-form.input :label="'Texto de Botón'" :name="'button_text'" :model="'text_button'" :required="'required'" />
                </div>
                <div>
