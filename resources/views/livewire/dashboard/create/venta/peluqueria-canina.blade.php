<div class="flex justify-between">
    <div class="w-full">
        ...
        <div>
            <div>
                <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white mt-2">{{ $pet_name }}</h2>
            </div>
            ...
            <div>
                <form wire:submit.prevent="agregarItem" class="space-y-10 max-w-md">
                    ...
                    <div>
                        <x-form.select :label="'Especialista'" :name="'user_id'" :model="'user_id'">
