        ...
        <div class="relative overflow-x-auto sm:overflow-hidden mt-10 sm:mt-5">
                ...
                <tbody class="bg-white text-center">
                    ...
                    <tr >
                        ...
                        <td class="{{ $td }}">
                            {{ $notification->appointment->format('H:i m/d') }}
                        </td>
                        ...
                        <td class="py-4 px-1 flex justify-center">
                            ...
                            <div class="flex justify-between gap-2" style="max-width: 250px;">
                                ...
                                <div>
                                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Marcar como entregado</button>
                                </div>
                            </div>
                        </td>
                    </tr class="bg-white border-b">
