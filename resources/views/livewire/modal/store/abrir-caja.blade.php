        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form wire:submit.prevent="submit" class="space-y-4 p-4">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <x-jet-label for="caja" value="{{ __('En Caja') }}" />
                    <x-jet-input id="caja" type="number" class="mt-1 block w-full" wire:model.defer="en_caja" autocomplete="en_caja" min="0"  />
                    <x-jet-input-error for="phone" class="mt-2" />
                    @error('caja') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
