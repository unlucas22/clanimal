<div>
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form wire:submit.prevent="submit" class="space-y-4 p-4" id="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-jet-input id="message" type="text" class="mt-1 block w-full" wire:model="message" />
                    <x-jet-input-error for="message" class="mt-2" />
                    @error('message') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <div>
                    <x-form.select :name="'global'" :model="'global'" :label="'Tipo'">
                        <option value="0" selected>Sin procesar</option>
                ...
                <div>
                    ...
                    <select id="email" name="email" wire:model="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
